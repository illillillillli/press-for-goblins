...
import { ACCENT, SITE_URL, EYES_URL, QR_URL, ADDRESS_1, ADDRESS_2, FONT_BODY, FONT_DISPLAY } from './insignia.mjs';
...
export function preheaderSpan(text) {
  ...
  const fallback = `<div style="font-size:0;line-height:0;max-height:0;overflow:hidden;mso-hide:all;">&#8203;</div>`;
  return `${hidden}\n${fallback}`;
}
...
export function qrFooterBlock() {
  return `<tr class="anim-qr-footer">
    <td style="padding:0 0 28px 0;text-align:center;background:#010101;" bgcolor="#000000">
      ...
      <p style="margin:0;color:rgba(255,255,255,0.4);font-family:${FONT_BODY};font-size:15px;line-height:1.8;font-style:normal;">Press for Goblins<sup style="font-size:9.56px;line-height:0;vertical-align:super;">®</sup><br>${ADDRESS_1}<br><span style="white-space:nowrap;">${ADDRESS_2}</span><br><br><a href="${SITE_URL}" style="color:${ACCENT};font-family:${FONT_BODY};font-size:15px;text-decoration:none;">pressforgoblins.com</a></p>
    </td>
  </tr>`;
}
