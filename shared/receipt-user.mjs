...
const FIELD_LABELS = {
  ...
  'terms':       'terms',
  'terms-concern': 'questions',
};

const FIELD_ORDER = [
  'gate', 'writer-type', 'service', 'genre',
  'f-pitch', 'f-title', 'f-name', 'f-email', 'f-message', 'terms', 'terms-concern',
];
...
const GOBLIN_PROMPTS = {
  ...
  'terms':       { q: ['sound good?'] },
  'terms-concern': { q: ['of course you do'] },
};
...
const REACTIONS = {
  ...
  'writer-type': {
    ...
    'video game': 'we would beat you at goblin kart', 'tabletop game': 'we have been banned from several',
    __custom: 'noted',
  },
  service: {
    ...
    writing: 'we like working to a good brief', __custom: 'noted',
  },
  genre: {
    'sci-fi': 'good territory', fantasy: 'our natural habitat',
    horror: 'we prefer a green pen, but our red one feels appropriate here',
    romance: 'writing a good love story is harder than people think',
    'genre blend': 'of course it is', __custom: 'good to know',
  },
  terms: { "i'm in": 'splendid' },
};

function goblinRow(text) {
  return `<tr><td class="anim-goblin-row" style="background:#010101;padding:0 0 10px 0;" bgcolor="#000000"><span style="color:#74c58d;font-family:'Courier New',Courier,monospace;font-size:15px;">&gt;</span><span class="anim-goblin-text" style="color:rgba(255,255,255,0.88);font-family:'Courier New',Courier,monospace;font-size:15px;line-height:1.6;"> ${escapeHtml(text)}</span></td></tr>`;
}
...
function reactRow(text) {
  return `<tr><td class="anim-goblin-row" style="background:#010101;padding:0 0 18px 0;" bgcolor="#000000"><span style="color:#74c58d;font-family:'Courier New',Courier,monospace;font-size:15px;">&gt;</span><span class="anim-goblin-text" style="color:rgba(255,255,255,0.88);font-family:'Courier New',Courier,monospace;font-size:15px;line-height:1.6;"> ${escapeHtml(text)}</span></td></tr>`;
}
...
function buildChatRows(answers) {
  return FIELD_ORDER
    ...
    .flatMap(k => {
      ...
      const reaction = REACTIONS[k]?.[answers[k]] || REACTIONS[k]?.__custom;
...
export function buildHtml(answers, refNum) {
  ...
  const hwRows = `<tr>
    <td style="padding:0 0 32px 4px;text-align:left;background:#010101;" bgcolor="#000000">
      <p class="anim-hw" style="margin:0 0 5px 0;font-family:'Courier New',Courier,monospace;font-size:15px;line-height:1.6;letter-spacing:0.03em;color:rgba(255,255,255,0.88);text-align:left;"><span style="display:inline;font-family:'Courier New',Courier,monospace;font-size:15px;color:#74c58d;">&gt; </span>we have received your query</p>
      <p class="anim-hw" style="margin:0 0 5px 0;font-family:'Courier New',Courier,monospace;font-size:15px;line-height:1.6;letter-spacing:0.03em;color:rgba(255,255,255,0.88);text-align:left;"><span style="display:inline;font-family:'Courier New',Courier,monospace;font-size:15px;color:#74c58d;">&gt; </span>expect our verdict within two weeks</p>
      <p class="anim-hw" style="margin:0 0 5px 0;font-family:'Courier New',Courier,monospace;font-size:15px;line-height:1.6;letter-spacing:0.03em;color:rgba(255,255,255,0.88);text-align:left;"><span style="display:inline;font-family:'Courier New',Courier,monospace;font-size:15px;color:#74c58d;">&gt; </span>that will be all, human</p>
      <p class="anim-hw anim-reply-line" style="margin:0;font-family:'Courier New',Courier,monospace;font-size:15px;line-height:1.6;letter-spacing:0.03em;color:rgba(255,255,255,0.88);text-align:left;"><span style="display:inline;font-family:'Courier New',Courier,monospace;font-size:15px;color:#74c58d;">&gt; </span>you may reply to this receipt<sup style="font-size:12px;vertical-align:top;line-height:1;color:rgba(255,255,255,0.88);">*</sup></p>
    </td>
  </tr>`;
