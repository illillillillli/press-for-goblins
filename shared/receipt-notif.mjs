...
import { makeRefNum } from './receipt-user.mjs';
...
function goblinRow(text) {
  return `<tr><td style="background:#010101;padding:0 0 10px 0;" bgcolor="#000000"><span style="color:#74c58d;font-family:'Courier New',Courier,monospace;font-size:15px;">&gt;</span><span style="color:rgba(255,255,255,0.88);font-family:'Courier New',Courier,monospace;font-size:15px;line-height:1.6;"> ${escapeHtml(text)}</span></td></tr>`;
}
...
function reactRow(text) {
  return `<tr><td style="background:#010101;padding:0 0 18px 0;" bgcolor="#000000"><span style="color:#74c58d;font-family:'Courier New',Courier,monospace;font-size:15px;">&gt;</span><span style="color:rgba(255,255,255,0.88);font-family:'Courier New',Courier,monospace;font-size:15px;line-height:1.6;"> ${escapeHtml(text)}</span></td></tr>`;
}
